...
/**
 * SplashCursor — WebGL fluid simulation cursor effect (разноцветный «дым» за курсором).
 * Source: https://www.reactbits.dev/r/SplashCursor-JS-CSS
 * Palette: magenta / plum (Ekaterina Shmidt presskit).
 */
...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Magenta · pink · violet (hue 0.82–0.98)
      const h = 0.82 + Math.random() * 0.16;
